    ...
    extends AbstractJUnit4MojoTestCase
{
    ...
    public void testSkipCheckoutWithConnectionUrl()
        throws Exception
    {
        checkScmPresence( SvnScmTestUtils.SVNADMIN_COMMAND_LINE, "testSkipCheckoutWithConnectionUrl" );

        FileUtils.forceDelete( checkoutDir );

        SvnScmTestUtils.initializeRepository( repository );

        checkScmPresence( SvnScmTestUtils.SVN_COMMAND_LINE, "testSkipCheckoutWithConnectionUrl" );
    ...
    public void testUseExport()
        throws Exception
    {
        checkScmPresence( SvnScmTestUtils.SVN_COMMAND_LINE, "testUseExport" );
    ...
    public void testExcludeInclude()
        throws Exception
    {
        checkScmPresence( SvnScmTestUtils.SVNADMIN_COMMAND_LINE, "testExcludeInclude" );
        ...
        checkScmPresence( SvnScmTestUtils.SVN_COMMAND_LINE, "testExcludeInclude" );
