 ...
 *
 */
class LocalRepositoryTest extends ScmTestCase {
    @BeforeEach
    @Override
    ...
    @Test
    void existingRepository() throws Exception {
    ...
    @Test
    void missingRepositoryRoot() throws Exception {
        try {
    ...
    @Test
    void nonExistingMissingRepositoryRoot() throws Exception {
        try {
    ...
    @Test
    void missingModule() throws Exception {
        try {
    ...
    @Test
    void nonExistingModule() throws Exception {
        try {
