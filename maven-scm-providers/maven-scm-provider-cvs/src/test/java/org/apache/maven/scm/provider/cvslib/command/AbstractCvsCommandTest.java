 ...
 * @version $Id$
 */
public abstract class AbstractCvsCommandTest
...
/*
    public void testSetInvalidRepository()
        throws Exception
    {
        String scmUrl = "scm:cvs:INVALID";

        ScmResult result = execute( CheckOutCommand.NAME, scmUrl, getWorkingDirectory(), new CommandParameters() );
