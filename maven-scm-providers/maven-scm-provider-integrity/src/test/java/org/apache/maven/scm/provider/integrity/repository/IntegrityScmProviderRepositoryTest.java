...
public class IntegrityScmProviderRepositoryTest extends ScmTestCase
{
	...
	public void testWithUserAndHostPort() throws Exception
	{
		...
		testValidUrl("scm:integrity|dsouza@localhost:7001|#/repo/project", "#/repo/project", "localhost", 7001, "dsouza", "");
	}
	...
	public void testWithUserPasswordAndHost() throws Exception
	{
		...
		testValidUrl("scm:integrity|dsouza/password@localhost|#/repo/project", "#/repo/project", "localhost", 0, "dsouza", "password");
	}
	...
	public void testWithWholeURL() throws Exception
	{
		...
		testValidUrl("scm:integrity|dsouza/password@localhost:7001|#/repo/project", "#/repo/project", "localhost", 7001, "dsouza", "password");
	}
	 ...
	 * @throws Exception
	 */
	private void testValidUrl(String scmUrl, String expectedConfigPath, 
