...
public class PushException extends Exception {
    ...
    public PushException(String url, RemoteRefUpdate update) {
        super("Failed to push reference to " + url + ": " + update);
    }

    public PushException(String url, GitAPIException e) {
        super("Failed to push reference to " + url + ": " + e.getMessage(), e);
    }
}
