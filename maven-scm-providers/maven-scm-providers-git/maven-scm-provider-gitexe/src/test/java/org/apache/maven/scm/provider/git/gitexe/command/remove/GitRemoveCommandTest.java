 ...
 */
class GitRemoveCommandTest extends ScmTestCase {

    @Test
    void commandRemoveWithFile() throws Exception {
    ...
    @Test
    void commandRemoveWithDirectory() throws Exception {
        File workingDirectory = createTempDirectory();
    ...
    @Test
    void commandRemoveWithTwoDirectory() throws Exception {
        File workingDirectory = createTempDirectory();
