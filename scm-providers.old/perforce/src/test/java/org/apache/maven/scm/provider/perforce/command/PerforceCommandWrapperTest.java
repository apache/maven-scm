 ...
 * @version $Id$
 */
public class PerforceCommandWrapperTest extends TestCase
{
    private PerforceCommandWrapper wrapper;
    
    public PerforceCommandWrapperTest(String testName)
    {
        super(testName);
    }
    ...
    {
        wrapper = new PerforceCommandWrapper();
    }
    ...
    public void testSetValidRepository()
    {
        try
        {
            ...
            repo.setDelimiter(":");
            repo.setConnection("pserver:anonymous@Perforce.apache.org:/scm:maven");
