 ...
 * @version $Id$
 */
public class AbstractPerforceCommandTest extends TestCase
{
    private TestAbstractPerforceCommand cmd;
    
    public AbstractPerforceCommandTest(String name)
    {
        super(name);
    }
    ...
    {
        cmd = new TestAbstractPerforceCommand();
    }
