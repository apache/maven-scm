 ...
 * @version $Id$
 */
public class StarteamCommandWrapperTest extends TestCase
{
    private StarteamCommandWrapper wrapper;
    
    public StarteamCommandWrapperTest(String testName)
    {
        super(testName);
    }
    ...
    {
        wrapper = new StarteamCommandWrapper();
    }
