 ...
 * @version $Id$
 */
public class StarteamUpdateCommandTest extends TestCase
{
    public StarteamUpdateCommandTest(String testName)
    {
        super(testName);
    }
    ...
    public void testGetDisplayNameName()
    {
        try
        {
            StarteamUpdateCommand cmd = new StarteamUpdateCommand();
